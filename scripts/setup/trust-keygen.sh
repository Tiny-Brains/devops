...
#
# Writes devops/keys/tinybrains-dev.pem (mode 0600, git-ignored) and TB_TRUST_PUBLIC_KEY into
# devops/.env, which both instance configs read as `[plugins.trust] public_keys`.
#
